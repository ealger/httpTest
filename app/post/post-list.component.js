...
var PostListComponent = (function () {
    ...
    PostListComponent.prototype.getPosts = function () {
        ...
        this._postDataService.getData()
            .subscribe(function (posts) { _this.posts = posts.response.result.doc; console.log("posts=", posts.response.result.doc); }, function (error) { return _this.errorMessage = error; });
    };
